...
<Code
  code={`<script
    ...
    src="https://cdn.docspring.com/visual_form.v${getEmbedVersion("visual_form")}.js"
></script>`}
  lang="html"
...
<Aside type="note">
  ...
  instead of the CDN:
  `https://docspring.yourcompany.com/assets/embed/visual_form.css` and
  `https://docspring.yourcompany.com/assets/embed/visual_form.js`.
</Aside>
