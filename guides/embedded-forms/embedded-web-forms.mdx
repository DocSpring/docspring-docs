...
<Aside type="note">
  Enterprise deployments can load these assets from the local DocSpring domain
  instead of the CDN:
  `https://docspring.yourcompany.com/assets/embed/simple_form.css` and
  `https://docspring.yourcompany.com/assets/embed/simple_form.js`.
</Aside>
