...
`onDone` fires when the Done button is clicked. Modal editors close automatically after `onDone` and `onEvent` run. See the main embed guide for the full callback list.
