...
DocSpring has completed a SOC 2 Type II audit and is GDPR and HIPAA compliant.
We are happy to sign a Business Associate Agreement (BAA) with customers on request.
Contact [enterprise@docspring.com](mailto:enterprise@docspring.com) to request a BAA.
You must sign a BAA with us before submitting any protected health information (PHI) to DocSpring.

<LinkCard
  title="Security and Compliance"
  href="https://docspring.com/security#hipaa"
  description="Read about HIPAA compliance, BAAs, and how DocSpring protects your data."
/>
