...
import multilineNameExampleImg from "@images/template_editor/multiline-name-example.jpg";
import multilineCheckboxImg from "@images/template_editor/multiline-checkbox.png";
...
<Image src={multilineNameExampleImg} alt="Multiline field names" width={700} />
...
<Image src={multilineCheckboxImg} alt="Multiline checkbox option" width={250} />
...
<Image src={dayMonthYearImg} alt="Day, month, year fields" width={500} />
